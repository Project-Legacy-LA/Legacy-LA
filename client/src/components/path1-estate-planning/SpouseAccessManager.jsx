    ...
    <div ref={pageRef} className="min-h-screen text-black bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
          {/* Spouse Email */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Invite Spouse</h2>
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  <p className="text-sm text-blue-700">
                    Enter your spouse's email address. They will receive an invitation link to create their account.
                  </p>
                </div>
              </div>
