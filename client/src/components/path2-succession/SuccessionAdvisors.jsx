      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div ref={headerRef} className="mb-8">
          <h1 className="text-3xl font-bold text-black mb-2" style={{ fontFamily: 'var(--ll-font)' }}>
            Succession - Professional Advisors
          </h1>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-gray-700">
              Please list any professionals or advisors who may have worked with the decedent or who may have information helpful in completing the succession. This could include individuals or firms involved in the decedent's financial, legal, accounting, or insurance matters. We use this information to locate important records, verify account details, and coordinate where needed to ensure assets are properly transferred. If you're unsure about any of these, just fill in what you know - even partial names or firm names are helpful.
            </p>
          </div>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
            <button
              type="button"
              onClick={() => navigate('/succession/roles')}
