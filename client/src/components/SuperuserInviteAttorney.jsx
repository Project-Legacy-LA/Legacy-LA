    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          As a superuser, invite an attorney by providing their email address and the tenant display name. They will receive an email with instructions to activate their account.
        </p>
      </div>
