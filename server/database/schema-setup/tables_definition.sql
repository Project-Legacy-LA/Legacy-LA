...
-- === Enums ===
DO $$ BEGIN CREATE TYPE user_status_enum AS ENUM ('active','disabled'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE membership_role_enum AS ENUM ('attorney_owner','paralegal','staff'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE client_status_enum AS ENUM ('active','archived'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE relationship_status_enum AS ENUM ('single','married','divorced','widowed','partnered','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE person_role_enum AS ENUM ('client_primary','spouse','child','beneficiary','advisor','trustee','representative','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE life_status_enum AS ENUM ('alive','deceased'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE adoption_status_enum AS ENUM ('none','adopted','stepchild','foster'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE incapacity_status_enum AS ENUM ('none','permanent_incapacity'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE relationship_type_enum AS ENUM ('biological_parent','adoptive_parent','step_parent','legal_guardian','custodial_parent','non_custodial_parent','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE parental_rights_enum AS ENUM ('full','joint','sole','terminated','unknown'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE title_form_enum AS ENUM ('sole','jtwros','tenancy_in_common','trust_titled','custodial_utma','custodial_ugma','usufruct','naked_ownership','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE marital_character_enum AS ENUM ('community','separate','quasi_community','unknown'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE asset_category_enum AS ENUM ('real_estate','personal_property','vehicle','bank','brokerage','retirement','annuity','life_insurance','employer_equity','education_account','hsa_fsa','crypto_alts','reits_interest','business_interest','trust_interest','future_interest_iou','promissory_note','donor_advised_fund','patent','royalty_interest','mineral_interest','savings_bond','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE probate_class_enum AS ENUM ('probate','non_probate','contingent_to_trust'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE instrument_type_enum AS ENUM ('RSU','ISO','NSO'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE beneficiary_tier_enum AS ENUM ('primary','contingent'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE verification_status_enum AS ENUM ('draft','confirmed'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE liability_kind_enum AS ENUM ('primary_mortgage','second_mortgage','heloc','vehicle_loan','personal_loan','credit_card','student_loan','business_loan','admin_cost','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE bequest_type_enum AS ENUM ('specific','percentage','residuary'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE trust_type_enum AS ENUM ('revocable','irrevocable','family','other'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE v_asset uuid; need boolean; has_primary boolean;
BEGIN
  v_asset := CASE WHEN TG_OP = 'DELETE' THEN OLD.asset_id ELSE NEW.asset_id END;
  SELECT a.beneficiary_designation_required INTO need FROM app.asset a WHERE a.asset_id = v_asset;
  IF need THEN
    SELECT EXISTS (SELECT 1 FROM app.beneficiary_designation bd WHERE bd.asset_id = v_asset AND bd.tier = 'primary') INTO has_primary;
...
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE v_role membership_role_enum;
BEGIN
...
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE v_cat asset_category_enum;
BEGIN
  IF NEW.secured_asset_id IS NULL THEN RETURN NEW; END IF;
  SELECT a.category INTO v_cat FROM app.asset a WHERE a.asset_id = NEW.secured_asset_id;
